    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_robots_interfaces.msg.LedStateArray')
            logger.debug(
...
class LedStateArray(metaclass=Metaclass_LedStateArray):
    ...
    def __init__(self, **kwargs):
        ...
        self.array_of_leds = array.array('q', kwargs.get('array_of_leds', []))
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.array_of_leds != other.array_of_leds:
            return False
        return True
    ...
    @builtins.property
    def array_of_leds(self):
        """Message field 'array_of_leds'."""
        return self._array_of_leds

    @array_of_leds.setter
    def array_of_leds(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'q', \
                "The 'array_of_leds' array.array() must have the type code of 'q'"
            self._array_of_leds = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'array_of_leds' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        self._array_of_leds = array.array('q', value)
