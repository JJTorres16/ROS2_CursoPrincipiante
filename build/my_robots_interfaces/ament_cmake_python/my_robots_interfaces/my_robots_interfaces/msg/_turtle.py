...
class Turtle(metaclass=Metaclass_Turtle):
    ...
    def __init__(self, **kwargs):
        ...
        self.name_turtle = kwargs.get('name_turtle', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.name_turtle != other.name_turtle:
            return False
        if self.x != other.x:
            return False
        if self.y != other.y:
    ...
    @builtins.property
    def name_turtle(self):
        """Message field 'name_turtle'."""
        return self._name_turtle

    @name_turtle.setter
    def name_turtle(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'name_turtle' field must be of type 'str'"
        self._name_turtle = value
