...
#include "my_robots_interfaces/msg/detail/hardware_status__rosidl_typesupport_fastrtps_c.h"
...
using _HardwareStatus__ros_msg_type = my_robots_interfaces__msg__HardwareStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: motors_are_ready
  {
    cdr << (ros_message->motors_are_ready ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: motors_are_ready
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->motors_are_ready = tmp ? true : false;
  }
...
size_t get_serialized_size_my_robots_interfaces__msg__HardwareStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name motors_are_ready
  {
    size_t item_size = sizeof(ros_message->motors_are_ready);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name debug_message
...
static uint32_t _HardwareStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robots_interfaces__msg__HardwareStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robots_interfaces
size_t max_serialized_size_my_robots_interfaces__msg__HardwareStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _HardwareStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robots_interfaces__msg__HardwareStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robots_interfaces, msg, HardwareStatus)() {
