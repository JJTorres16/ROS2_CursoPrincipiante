...
#include "my_robots_interfaces/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robots_interfaces::srv::CatchTurtle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robots_interfaces::srv::CatchTurtle_Request & ros_message)
{
  // Member: turtle_name
  cdr >> ros_message.turtle_name;
...
{
  auto typed_message =
    static_cast<const my_robots_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robots_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  return &my_robots_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robots_interfaces, srv, CatchTurtle_Request)() {
  return &my_robots_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robots_interfaces
cdr_serialize(
  const my_robots_interfaces::srv::CatchTurtle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robots_interfaces::srv::CatchTurtle_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const my_robots_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robots_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robots_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robots_interfaces, srv, CatchTurtle_Response)() {
  return &my_robots_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
{
  return &my_robots_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robots_interfaces, srv, CatchTurtle)() {
  return &my_robots_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
