    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_robots_interfaces.msg.HardwareStatus')
            logger.debug(
...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.motors_are_ready = kwargs.get('motors_are_ready', bool())
    ...
    def __eq__(self, other):
        ...
        if self.temperature != other.temperature:
            return False
        if self.motors_are_ready != other.motors_are_ready:
            return False
    ...
    @builtins.property
    def motors_are_ready(self):
        """Message field 'motors_are_ready'."""
        return self._motors_are_ready

    @motors_are_ready.setter
    def motors_are_ready(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'motors_are_ready' field must be of type 'bool'"
        self._motors_are_ready = value
